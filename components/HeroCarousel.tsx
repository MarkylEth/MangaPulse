...
/** Можно расширить объект баннера без ломающей совместимости */
export type CarouselItem = {
  id: number | string;
  title: string;
  coverUrl: string;       // например: /banners/2.jpg (из public)
  href: string;           // ссылка на тайтл/чтение
  detailsHref?: string;   // опционально: страница тайтла
  badge?: string;         // опционально: ярлык (Новинка, Эксклюзив и т.п.)
  subtitle?: string;      // опционально: короткий подзаголовок
};
...
type Props = {
  ...
  autoplayMs?: number;
  /** высота карусели (tailwind-класс) */
  heightClass?: string;
};
